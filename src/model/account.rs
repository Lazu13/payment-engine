...
pub struct Account {
    ...
    pub total: Decimal,
    pub locked: bool,
    deposits_amounts: HashMap<TransactionId, PositiveScale4BigDecimal>,
    disputes_amounts: HashMap<TransactionId, PositiveScale4BigDecimal>,
}
...
impl Account {
    ...
    pub fn withdraw(&mut self, total: PositiveScale4BigDecimal) -> MyResult<()> {
    ...
    pub fn deposit(&mut self, tx: TransactionId, total: PositiveScale4BigDecimal) -> MyResult<()> {
        self.validate_locked()?;
    ...
    ) -> MyResult<PositiveScale4BigDecimal> {
